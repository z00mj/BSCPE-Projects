...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['mine'])) {
    ...
    header("Location: main.php?mineMessage=" . urlencode($mineMessage));
    exit();
}
...
<body>
    <div class="container">
        ...
        <aside class="sidebar">
            ...
            <nav>
                <ul class="nav-menu">
                    <li><a href="main.php" class="active"><i class="fas fa-home icon"></i> Home</a></li>
        ...
        <main class="main-content">
            ...
            <div class="carousel-container">
                <div class="carousel-wrapper">
                    <div class="carousel-track" id="carouselTrack">
                        ...
                        <div class="carousel-slide" onclick="location.href='games/blackjack.php'" style="cursor: pointer;">
                            <img src="images/blackjack-poster.png"
                                style="width: 100%; height: 100%; object-fit: cover;">
                        </div>

                        <!-- Slide 2 -->
                        <div class="carousel-slide" onclick="location.href='games/coinflip.php'" style="cursor: pointer;">
                            <img src="images/coin-flip-poster.png"
                                style="width: 100%; height: 100%; object-fit: cover;">
                        </div>

                        <!-- Slide 3 -->
                        <div class="carousel-slide" onclick="location.href='games/towerclimb.php'" style="cursor: pointer;">
                            <img src="images/tower-climb-poster.png"
                                style="width: 100%; height: 100%; object-fit: cover;">
                        </div>

                        <!-- Slide 4 -->
                        <div class="carousel-slide" onclick="location.href='games/colorbet.php'" style="cursor: pointer;">
                            <img src="images/color-bet-poster.png"
                                style="width: 100%; height: 100%; object-fit: cover;">
                        </div>

                        <!-- Slide 5 -->
                        <div class="carousel-slide" onclick="location.href='games/highlow.php'" style="cursor: pointer;">
                            <img src="images/high-low-poster.png" style="width: 100%; height: 100%; object-fit: cover;">
                        </div>
                    </div>
            ...
            <section class="popular-games-section" style="margin-top: 40px;">
                <div class="section-header"
                    style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                    <h2 id="section-title" style="font-size: 24px; font-weight: bold; color: white;">All Games</h2>
                    <a href="game.php" style="color: #e4b44c; text-decoration: none; font-weight: 500;">See All</a>
                </div>
    ...
    <script>
        ...
        function showSlide(index) {
            ...
            if (index >= 5) currentSlideIndex = 0;
            else if (index < 0) currentSlideIndex = 4;
