...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['mine'])) {
    ...
    header("Location: account.php?mineMessage=" . urlencode($mineMessage));
    exit();
}
?>
...
<body>
    <div class="container">
        ...
        <aside class="sidebar">
            ...
            <nav>
                <ul class="nav-menu">
                    ...
                    <li><a href="game.php"><i class="fas fa-gamepad icon"></i> Games</a></li>
                    <li><a href="account.php" class="active"><i class="fas fa-user icon"></i> Account</a></li>
                </ul>
            </nav>
        </aside>
        ...
        <main class="main-content">
            ...
            <div class="account-management">
                <h1 style="font-size: 28px; margin-bottom: 30px; color: white;">Account Management</h1>

                <div class="account-container">
                    <!-- Left Sidebar Menu -->
                    <div class="account-sidebar">
                        <div class="account-menu-item active" onclick="showTab('information')">
                            <i class="fas fa-user"></i>
                            <span>Information</span>
                        </div>
                        <div class="account-menu-item" onclick="showTab('password')">
                    ...
                    <div class="account-content">
                        ...
                        <div id="information" class="tab-content active">
                            ...
                            <div class="info-row">
                                ...
                                <div class="info-value" id="nickname-display"><?= htmlspecialchars($user['username']) ?></div>
                                <div class="info-edit" id="nickname-edit" style="display: none;">
                                    <input type="text" class="edit-input" id="nickname-input" value="<?= htmlspecialchars($user['username']) ?>">
                                    <button class="save-btn" onclick="saveField('nickname')">Save</button>
                                    <button class="cancel-btn" onclick="cancelEdit('nickname')">Cancel</button>
                                </div>
                                <button class="modify-btn" onclick="editField('nickname')">Modify</button>
                            </div>
                            <div class="info-row">
                                <div class="info-label">Email</div>
                                <div class="info-value" id="email-display">*******</div>
                                <div class="info-edit" id="email-edit" style="display: none;">
                                    <div
                                        style="display: flex; flex-direction: column; gap: 10px; flex: 1; max-width: 600px;">
                                        <input type="email" class="edit-input" id="current-email-input"
                                            placeholder="Enter current email">
                                        <input type="email" class="edit-input" id="new-email-input"
                                ...
                                <button class="modify-btn" onclick="editField('email')">Modify</button>
                            </div>
                        </div>
                            ...
                            <div class="password-form">
                                <div class="password-row">
                                    <div class="password-labels">
                                        ...
                                        <div class="password-label">Password Again</div>
                                    </div>
                                    <div class="password-inputs">
                                        <div style="position: relative; display: flex;">
                                            <input type="password" id="new-password" placeholder="New Password" class="password-input" style="flex: 1;">
                                            <i class="fas fa-eye toggle-password" onclick="togglePassword('new-password', this)" style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); cursor: pointer; color: #e4b44c;"></i>
                                        </div>
                                        <div style="position: relative; display: flex;">
                                            <input type="password" id="confirm-password" placeholder="Re-enter New Password" class="password-input" style="flex: 1;">
                                            <i class="fas fa-eye toggle-password" onclick="togglePassword('confirm-password', this)" style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); cursor: pointer; color: #e4b44c;"></i>
                                        </div>
                                    </div>
                                </div>
                                <button class="password-confirm-btn" onclick="changePassword()">Confirm</button>
                            </div>
                        </div>
    ...
    <script>
        ...
        function saveField(fieldName) {
            ...
            let newValue = inputElement ? inputElement.value.trim() : '';

            if (fieldName === 'email') {
                const currentEmail = document.getElementById('current-email-input').value.trim();
                newValue = document.getElementById('new-email-input').value.trim();
            ...
            // ✅ Fix: Map "nickname" to "username" before sending
            ...
            fetch('backend/update_profile.php', {
                ...
                .then(data => {
                    if (data.success) {
                        if (fieldName === 'email') {
                            showSuccessMessage('Email updated! Logging you out...');
                            setTimeout(() => {
                        ...
                        // If not email, just update display
